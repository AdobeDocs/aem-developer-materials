...
describe('Coral.Component', function() {
  ...
  describe('Namespace', function() {
    it('should be defined', function() {
      expect(Coral).to.have.property('Component');
    });

    it('should define the tracking in an enum', function() {
      expect(Coral.Component.tracking).to.exist;
    });
  });
  ...
  describe('Instantiation', function() {
    ...
    it('should support cloning using markup', function() {
    ...
    it('should support cloning an identical twin', function(done) {
      var component = new Coral.ComponentTestComponent();
  ...
  describe('API', function() {
    ...
    describe('#tracking', function() {
      it('should default to "ON"', function() {
        ...
        expect(component.tracking).to.exist;
        expect(component.tracking).to.equal(Coral.Component.tracking.ON);
      });

      it('should allow setting "OFF"', function() {
        var component = new Coral.ComponentTestComponent();

        component.tracking = Coral.Component.tracking.OFF;

        expect(component.tracking).to.equal(Coral.Component.tracking.OFF);
      });
    });
