describe('Coral.Radio', function() {
  ...
  describe('Tracking', function() {
    ...
    it('should call the tracker callback fn only once when clicking on the same radio input twice', function(done) {
      helpers.build('<div><coral-radio name="a" value="aa">First</coral-radio><coral-radio name="a" value="second">Second</coral-radio></div>', function(el) {
    ...
    it('should call the tracker callback fn once when selecting the radio with expected trackData parameters', function(done) {
      helpers.build('<coral-radio name="radioName" value="radioValue" trackingelement="element name" trackingfeature="feature name">Some Label</coral-radio>', function(el) {
        el.click();
        ...
        expect(trackData).to.have.property('targetType', 'radio');
        ...
        expect(trackData).to.have.property('rootType', 'radio');
        expect(spyCall.args[1]).to.be.an.instanceof(MouseEvent);
        expect(spyCall.args[2]).to.be.an.instanceof(Coral.Radio);
        done();
      });
    });

    it('should call the tracker callback fn with targetElement value from the "name=value" value when the "name" attribute is present', function(done) {
      helpers.build('<coral-radio name="radioName" value="radioValue" trackingfeature="feature name">Some Label</coral-radio>', function(el) {
        el.click();
    ...
    it('should call the tracker callback fn with targetElement value from the label when the "name" attribute is missing', function(done) {
      helpers.build('<coral-radio value="radioValue" trackingfeature="feature name">Some Label</coral-radio>', function(el) {
        el.click();
