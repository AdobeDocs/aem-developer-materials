describe('Coral.WizardView', function() {
  ...
  describe('Events', function() {
    ...
    describe('coral-wizardview:change', function() {
      ...
      it('should not trigger an event when next() is called and there are no steplists', function(done) {
        var changeSpy = sinon.spy();

        helpers.build(window.__html__['Coral.WizardView.empty.html'], function(el) {
          el.on('coral-wizardview:change', changeSpy);
      ...
      it('should not trigger an event when previous() is called and there are no steplists', function(done) {
        var changeSpy = sinon.spy();
      ...
      it('should not trigger an event when next() is called and it is already the last item', function(done) {
        var changeSpy = sinon.spy();
  ...
  describe('Implementation Details', function() {
    it('should deselect the panel if there if there is no matching step', function(done) {

      helpers.build(window.__html__['Coral.WizardView.irregular.html'], function(el) {
        var stepList = el.stepLists.first();
  ...
  describe('Tracking', function() {
    ...
    it('should call tracker callback with the expected tracker data when "Next" button is clicked', function(done) {
      helpers.build(window.__html__['Coral.WizardView.full.trackingAnnotated.html'], function(el) {
        ...
        expect(trackData).to.have.property('targetType', 'wizardview');
        ...
        expect(trackData).to.have.property('rootType', 'wizardview');

        spyCall = trackerFnSpy.getCall(1);
        trackData = spyCall.args[0];

        expect(trackData).to.have.property('targetType', 'wizardview-next');
    ...
    it('should call tracker callback with the expected tracker data when stepping back and forth clicking "Next" and "Previous" buttons', function(done) {
      helpers.build(window.__html__['Coral.WizardView.full.trackingAnnotated.html'], function(el) {
        ...
        expect(trackData).to.have.property('targetType', 'wizardview-previous');
    ...
    it('should not call tracker callback when clicking on "Next" button and tracking is disabled for both wizard and buttons', function(done) {
      helpers.build(window.__html__['Coral.WizardView.full.trackingAnnotated.html'], function(el) {
        el.tracking = Coral.Component.tracking.OFF;
    ...
    it('should call tracker callback with expected data when clicking on the Step from the StepList', function(done) {
      helpers.build(window.__html__['Coral.WizardView.full.trackingAnnotated.html'], function(el) {
        ...
        expect(trackData).to.have.property('targetType', 'wizardview-steplist-step');
        expect(trackData).to.have.property('targetElement', 'Coral Step 3');
        expect(trackData).to.have.property('eventType', 'click');
        expect(trackData).to.have.property('rootFeature', 'feature name');
        expect(trackData).to.have.property('rootElement', 'element name');
