describe('CUI.Datepicker', function() {
    ...
    describe("with different date formats", function() {
        var html = '' +
            ...
            '  <input class="coral-InputGroup-input coral-Textfield" type="text" name="date_name" value="01..02..2012">' +
            '  <span class="coral-InputGroup-button">' +
            '    <button class="coral-Button coral-Button--secondary coral-Button--square" type="button">' +
            '      <i class="coral-Icon coral-Icon--sizeS coral-Icon--calendar"></i>' +
            '    </button>' +
    ...
    describe('User Interaction', function() {
      var getDisplayedYear = function(popover) {
        return popover.find(".coral-DatePicker-calendarHeader .coral-Heading").text().replace(/\D/g, "");
      };
      
      it('should display next year calendar if on last month and next is clicked', function(done) {
        var html = '' +
          '<div class="coral-InputGroup">' +
          '  <input class="coral-InputGroup-input coral-Textfield" value="2018-12-01" type="date" name="date1">' +
          '  <span class="coral-InputGroup-button">' +
          '    <button class="coral-Button coral-Button--secondary coral-Button--square" type="button">' +
          '    <i class="coral-Icon coral-Icon--sizeS coral-Icon--calendar"></i>' +
          '      </button>' +
        ...
        // Wait for popover
        setTimeout(function() {
          var popover = $("body").find(".coral-Popover--datepicker").last();
          
          expect(getDisplayedYear(popover)).to.equal("2018");

          popover.find(".coral-DatePicker-nextMonth").trigger("mousedown");
          
          expect(getDisplayedYear(popover)).to.equal("2019");

          done();
        }, 200);
      });
      
      it('should display previous year calendar if on first month and previous is clicked', function(done) {
        var html = '' +
          '<div class="coral-InputGroup">' +
          '  <input class="coral-InputGroup-input coral-Textfield" value="2018-01-01" type="date" name="date1">' +
          '  <span class="coral-InputGroup-button">' +
          '    <button class="coral-Button coral-Button--secondary coral-Button--square" type="button">' +
          '    <i class="coral-Icon coral-Icon--sizeS coral-Icon--calendar"></i>' +
          '      </button>' +
        ...
        setTimeout(function() {
          ...
          popover.find(".coral-DatePicker-prevMonth").trigger("mousedown");
  
          expect(getDisplayedYear(popover)).to.equal("2017");
