describe('Coral.CycleButton', function() {
  ...
  var SNIPPET_TRACKING_ON_WITHATTRS = window.__html__['Coral.CycleButton.trackingOnWithAttrs.html'];
  var SNIPPET_WITHACTIONS_WITHTRACKING = window.__html__['Coral.CycleButton.withActions.withTracking.html'];
  ...
  describe('Tracking', function() {
    ...
    it('should call tracker callback only once when the button is clicked', function(done) {
      helpers.build(SNIPPET_TRACKING_ON_WITHATTRS, function(el) {
        el._elements.button.click();
    ...
    it('should call tracker callback with expected track data values when clicked', function(done) {
      helpers.build(SNIPPET_TRACKING_ON_WITHATTRS, function(el) {
        el._elements.button.click();
        ...
        helpers.next(function() {
          ...
          expect(trackData).to.have.property('targetType', 'cyclebutton');
    ...
    it('should call tracker callback twice with expected track data values when first item (with trackingelement attribute) is selected', function(done) {
      helpers.build(SNIPPET_TRACKING_ON_WITHATTRS, function(el) {
        el._elements.button.click();
        ...
        helpers.next(function() {
          ...
          helpers.next(function() {
            ...
            expect(trackData).to.have.property('targetType', 'cyclebutton-item');
    ...
    it('should call tracker callback twice with expected track data values when second item (without trackingelement attribute) is selected', function(done) {
      helpers.build(SNIPPET_TRACKING_ON_WITHATTRS, function(el) {
        el._elements.button.click();
    ...
    it('should call tracker callback twice with expected track data values when first action (with trackingelement attribute) is selected', function(done) {
      helpers.build(SNIPPET_WITHACTIONS_WITHTRACKING, function(el) {
        // opens the overlay
        el._elements.button.click();
        ...
        helpers.next(function() {
          ...
          helpers.next(function() {
            ...
            var spyCall = trackerFnSpy.getCall(1);
            var trackData = spyCall.args[0];
            expect(trackData).to.have.property('targetType', 'cyclebutton-action');
    ...
    it('should call tracker callback twice with expected track data values when second action (without trackingelement attribute) is selected', function(done) {
      helpers.build(SNIPPET_WITHACTIONS_WITHTRACKING, function(el) {
        // opens the overlay
        el._elements.button.click();
