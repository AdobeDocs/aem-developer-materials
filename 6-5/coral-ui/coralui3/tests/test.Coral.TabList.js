...
describe('Coral.TabList', function() {
  ...
  describe('API', function() {
    ...
    //     Coral.commons.nextFrame(function() {
    //       expect(el.classList.contains('coral3-TabList--large')).to.be.true;
    //       done();
    //     });
    //   });
    // });
    ...
    describe('#icon', function() {
      ...
      it('should be initially empty', function(done) {
        helpers.build(defaultMarkup, function(el) {
          ...
          expect(items[0].getAttribute('icon')).to.be.falsy;
  ...
  describe('Markup', function() {
    ...
    describe('#target', function() {
      ...
      it('should select the target after being inserted in the DOM', function(done) {
        helpers.build(window.__html__['Coral.TabList.virtualtarget.html'], function(el) {
  ...
  describe('Implementation Details', function() {
    ...
    //   Coral.commons.nextFrame(function() {
    //     expect(el.classList.contains('coral3-TabList--vertical')).to.be.true;
    //     done();
    //   });
    // });
  ...
  describe('Tracking', function() {
    ...
    it('should call the tracker callback with the expected trackData parameters when an item is clicked', function (done) {
      helpers.build(window.__html__['Coral.TabList.base.tracking.html'], function (el) {
        var items = el.items.getAll();
        items[0].click();
        ...
        expect(trackData).to.have.property('targetType', 'tablist-tab');
        ...
        expect(trackData).to.have.property('rootType', 'tablist');

        done();
      });
    });

    it('should call the tracker callback with the expected trackData parameters when an item that has annotations is clicked', function (done) {
      helpers.build(window.__html__['Coral.TabList.base.tracking.html'], function (el) {
        var items = el.items.getAll();
        items[1].click();
