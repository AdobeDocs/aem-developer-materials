describe('Coral.Collection', function() {
  ...
  before(function() {
    ...
    Coral.register({
      name: 'CollectionNestedTest',
      tagName: 'coral-collection-nested-test',
  ...
  describe('API', function() {
    ...
    describe('#options', function() {
      it('should default container to host', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
      ...
      it('should default itemSelector to the itemTagName', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
      ...
      it('should convert :scope in the item selector to an id', function(done) {
        helpers.build(window.__html__['Coral.Collection.nested.nested.html'], function(el) {
          expect(el.items._itemSelector).to.equal('coral-collection-test-item');
      ...
      it('should call onCollectionChange on both collections with the initial state', function(done) {
        helpers.build(window.__html__['Coral.Collection.nested.nested.html'], function(el) {
      ...
      it('should call onCollectionChange with the initial state', function(done) {
        helpers.build(window.__html__['Coral.Collection.nested.html'], function(el) {
      ...
      it('should not call onCollectionChange when items are not handled', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
      ...
      it('should not call onCollectionChange when the item is excluded', function(done) {
        helpers.build(window.__html__['Coral.Collection.nested.excluded.html'], function(el) {
      ...
      it('should not call any callback when there are no initial items', function(done) {
        helpers.build(window.__html__['Coral.Collection.nested.empty.html'], function(el) {
    ...
    describe('#length', function() {
      it('should return the amount of items', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
      ...
      it('should return the amount of items ignoring nested items', function(done) {
        helpers.build(window.__html__['Coral.Collection.nested.nested.html'], function(el) {
    ...
    describe('#getAll()', function() {
      ...
      it('should not return elements that do not pass the filter() function', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
          var all = el.items.getAll();
          expect(all.length).to.equal(5);
      ...
      it('should return all element when no filter is provided', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
    ...
    describe('#clear()', function() {
      it('should remove all the items except excluded', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
      ...
      it('should call onItemRemoved for every item removed', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
          el.items.clear();
    ...
    describe('#first()', function() {
      it('should return the first item in the collection', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
      ...
      it('should take the filter into consideration', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
          el.items._filter = undefined;
          expect(el.items.first().title).to.equal('Item 1');
      ...
      it('should return null if the collection is empty', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
          el.items.clear();
    ...
    describe('#last()', function() {
      it('should return the last item in the collection', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
    ...
    describe('#add()', function() {
      it('should append items directly to the element by default', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
      ...
      it('should allow to insertBefore an item', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
          var all = el.items.getAll();
      ...
      it('should append if insertBefore is null', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
          var newItem = el.items.add({
            title: '3'
          }, null);
      ...
      it('should call onItemAdded immediately after an item is added', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
          var item = el.items.add({
            title: 'Item 6'
          });
      ...
      it('should not call onItemAdded when the item is excluded', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
      ...
      it('should correctly call onItemAdded on nested and direct items', function(done) {
        helpers.build(window.__html__['Coral.Collection.nested.nested.html'], function(el) {
          var nestedEl = el.querySelector('coral-collection-nested-test');
      ...
      it('should delegate the call on onItemAdded when _startHandlingItems is called', function(done) {
        helpers.build(window.__html__['Coral.Collection.nested.subtree.html'], function(el) {
          // due to startHandlingItems, initial items also call the callback
      ...
      it('should not call onItemAdded if the host is not set', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
    ...
    describe('#remove()', function() {
      ...
      it('should call onItemRemoved', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
      ...
      it('should not call onItemRemoved when the item is excluded', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
      ...
      it('should not call onItemRemoved if the host is not set', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
      ...
      it('should not call onItemRemoved if the item was not in the DOM', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
    ...
    describe('#_startHandlingItems', function() {
      ...
      it('should process the initial items again if skipInitialItems=false', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
          ...
          helpers.next(function() {
            ...
            expect(onCollectionChangedSpy.callCount).to.equal(1, 'initial items should call collection change callback');
      ...
      it('should process the initial items again if skipInitialItems=false', function(done) {
        helpers.build(window.__html__['Coral.Collection.nested.nested.html'], function(el) {
          ...
          expect(onItemAddedNestedSpy.callCount).to.equal(itemCount, 'should wait for the MO');
          expect(onNestedCollectionChangedSpy.callCount).to.equal(2, 'Should be called by both outer and nested');

          helpers.next(function() {
            // this applies only to the outer items
            expect(onItemAddedNestedSpy.callCount).to.equal(itemCount + el.items.length, 'all items should call the callback');
            expect(onNestedCollectionChangedSpy.callCount).to.equal(3);
    ...
    describe('#_stopHandlingItems', function() {
      ...
      it('should have no side effects if _startHandlingItems has not previously called ', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.html'], function(el) {
  ...
  describe('Events', function() {
    describe('#coral-collection:add', function() {
      ...
      it('should not trigger collection events for initial items', function(done) {
        helpers.build(window.__html__['Coral.Collection.nested.html'], function(el) {
      ...
      it('should not trigger collection events for initial items (nested)', function(done) {
        helpers.build(window.__html__['Coral.Collection.nested.nested.html'], function(el) {
          var nestedEl = el.querySelector('coral-collection-nested-test');
      ...
      it('should not be triggered when text nodes are added', function(done) {
        helpers.build(window.__html__['Coral.Collection.nested.text.html'], function(el) {
  ...
  describe('Implementation Details', function() {
    describe('Handling items', function() {
      ...
      it('should correctly report the initial state', function(done) {
        helpers.build(window.__html__['Coral.Collection.nested.nested.html'], function(el) {
          var nestedEl = el.querySelector('coral-collection-nested-test');
      ...
      it('should allow custom item selectors', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.customAttribute.html'], function(el) {
          var collection = new Coral.Collection({
            host: el,
            itemTagName: 'coral-collection-test-item',
      ...
      it('should detect adding items that are not direct children', function(done) {
        helpers.build(window.__html__['Coral.Collection.base.subtree.html'], function(el) {
