describe('Coral.Select', function() {
  ...
  describe.skip('User Interaction', function() {
    ...
    describe('Removing the selected item', function() {
      ...
      it.skip('should not cause an error with single selection', function(done) {
        var changeSpy = sinon.spy();
      ...
      // TODO: Failing in scoped release
      it.skip('should not cause an error with multiple selection', function(done) {
        var changeSpy = sinon.spy();
    ...
    it('should remove selected items using the taglist when multiple=true', function(done) {
      helpers.build(window.__html__['Coral.Select.multiple.selected.html'], function(el) {
