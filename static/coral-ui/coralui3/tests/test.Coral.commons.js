describe('Coral.commons', function() {
  ...
  describe('#extend', function() {
    ...
    it('should combine properties from three objects', function() {
      var obj1 = { a: 1, b: 2, c: 3 };
      var obj2 = { b: 22, c: 33 };
      var obj3 = { a: 111, c: 444, d: 555 };

      var result = Coral.commons.extend(obj1, obj2, obj3);

      expect(Object.keys(result).length).to.equal(4);
      expect(result).to.have.property('a', 111);
      expect(result).to.have.property('b', 22);
      expect(result).to.have.property('c', 444);
      expect(result).to.have.property('d', 555);
  ...
  describe('#addResizeListener', function() {
    ...
    it('should call the provided callback whenever the size of the element is changed (due to content removed)', function(done) {
      var markup = '<div><div id="container"><div>Test</div></div></div>';
      helpers.build(markup, function(div) {
        var container = document.getElementById('container');
        Coral.commons.addResizeListener(div, function() {
