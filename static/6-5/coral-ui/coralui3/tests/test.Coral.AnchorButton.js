describe('Coral.AnchorButton', function() {
  ...
  describe('Tracking', function() {
    ...
    it('should call the tracker callback fn once with the expected data when the anchor button is clicked', function(done) {

      helpers.build('<a is="coral-anchorbutton" icon="heart" iconsize="S" trackingfeature="feature name" trackingelement="element name">\n' +
        '                Yay Kittens!\n' +
        '            </a>', function(el) {
        ...
        expect(trackData).to.have.property('targetType', 'anchorbutton');
        ...
        expect(trackData).to.have.property('rootType', 'anchorbutton');
        expect(spyCall.args[1]).to.be.an.instanceof(MouseEvent);
        expect(spyCall.args[2]).to.be.an.instanceof(Coral.AnchorButton);
