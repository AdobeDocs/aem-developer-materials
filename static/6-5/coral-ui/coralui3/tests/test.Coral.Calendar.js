describe('Coral.Calendar', function() {
  ...
  describe('User Interaction', function() {
    ...
    it('should go to next month on next month button click when max is set', function(done) {
      el.value = '2017-07-31';
      el.max = '2017-08-17';
    ...
    it('should go to next month on next month button click when min and max are set', function(done) {
    ...
    it('should go to previous month on previous month button click when min is set', function(done) {
      el.value = '2017-07-31';
      el.min = '2017-06-17';
  ...
  describe('Implementation Details', function() {
    describe('rendering', function() {
      it('should render correctly out of range dates', function(done) {
        helpers.build(window.__html__['Coral.Calendar.base.html'], function(el) {
