describe('Coral.Dialog', function() {
  ...
  */
  ...
  describe('Tracking', function() {
    ...
    it('should not call the tracker callback fn when the dialog is initialized and not opened', function(done) {
      helpers.build(window.__html__['Coral.Dialog.tracking.html'], function() {
    ...
    it('should call the tracker callback fn with expected parameters when the dialog is opened', function(done) {
      helpers.build(window.__html__['Coral.Dialog.tracking.html'], function(dialogEl) {

        dialogEl.on('coral-overlay:open', function() {
          ...
          expect(trackData).to.have.property('targetType', 'dialog');
          ...
          expect(trackData).to.have.property('rootType', 'dialog');
          expect(spyCall.args[1]).to.be.an.instanceof(CustomEvent);
          expect(spyCall.args[2]).to.be.an.instanceof(Coral.Dialog);
          done();
        });
    ...
    it('should call the tracker callback fn with expected parameters when the dialog is closed clicking on the "Close" button', function(done) {
      helpers.build(window.__html__['Coral.Dialog.tracking.html'], function(dialogEl) {
        ...
        dialogEl.on('coral-overlay:open', function() {
          dialogEl.querySelector('[coral-close]').click();
    ...
    it('should call the tracker callback fn with expected parameters when the dialog is closed clicking on the "x" closable button', function(done) {
      helpers.build(window.__html__['Coral.Dialog.tracking.html'], function(dialogEl) {
        ...
        dialogEl.on('coral-overlay:open', function() {
          dialogEl.querySelector('[coral-close][variant="minimal"]').click();
