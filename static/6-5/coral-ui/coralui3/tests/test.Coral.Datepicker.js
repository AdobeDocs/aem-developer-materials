describe('Coral.Datepicker', function() {
  ...
  describe('API', function() {
    ...
    describe('#displayFormat', function() {
      ...
      it('should allow setting a format with am/pm', function(done) {
        el.type = Coral.Datepicker.type.TIME;
    ...
    describe('#placeholder', function() {
      it('should default to ""', function() {
        ...
        expect(el.getAttribute('placeholder')).to.be.falsy;
      });
    ...
    describe('#readOnly', function() {
      it('should default to false', function() {
        ...
        expect(el.getAttribute('readonly')).to.be.falsy;
      });
      ...
      it('should set readonly', function(done) {
        ...
        helpers.next(function() {
          ...
          expect(el.getAttribute('readonly')).to.be.truthy;
          done();
        });
      });
    });
    ...
    describe('#value', function() {
      ...
      it('should reject invalid value strings', function(done) {
        helpers.build(window.__html__['Coral.Datepicker.value.invalid.1.html'], function(el) {
          expect(el.value).to.equal('');
          expect(el.getAttribute('value')).to.equal('nondate');
          expect(el.valueAsDate).to.be.null;
      ...
      it('should reject invalid date strings', function(done) {
        helpers.build(window.__html__['Coral.Datepicker.value.invalid.2.html'], function(el) {
          expect(el.value).to.equal('');
          expect(el.getAttribute('value')).to.equal('2000-02-30');
          expect(el.valueAsDate).to.be.null;
  ...
  describe('Tracking', function() {
    ...
    it('should call tracker callback with the expected tracker data when toggle button is clicked', function(done) {
      helpers.build(window.__html__['Coral.Datepicker.base.trackingOnWithAttributes.html'], function(el) {
        el._elements.toggle.click();
        ...
        el.on('coral-overlay:open', function() {
          ...
          expect(trackData).to.have.property('targetType', 'datepicker');
          ...
          expect(trackData).to.have.property('rootType', 'datepicker');
          done();
        });
