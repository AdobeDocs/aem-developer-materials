  ...
  */
  ...
  describe('Implementation Details', function() {
    ...
    if (supportsRangeInput) {
      ...
      describe('in browsers using that do not support input[type=range]', function() {
        it('expects the input to have type=hidden', function() {
          var input = el.querySelector('.' + TEST_ATTRIBUTES.classes.components.input);
          expect(input.type).to.equal('hidden');
        });

        it('expects the handle to have role=slider', function() {
          var handle = el.querySelector('.' + TEST_ATTRIBUTES.classes.components.handle);
        ...
        describe('expects the handle to have correct', function() {
          it('aria-valuemin', function(done) {
            ...
            helpers.next(function() {
              expect(Number(handle.getAttribute('aria-valuemin'))).to.equal(SLIDER_OPTIONS_MINIMAL.min);
              done();
            });
          });
          it('aria-valuemax', function(done) {
            ...
            helpers.next(function() {
              expect(Number(handle.getAttribute('aria-valuemax'))).to.equal(SLIDER_OPTIONS_MINIMAL.max);
              done();
            });
          });
          it('aria-valuestep', function(done) {
            ...
            helpers.next(function() {
              expect(Number(handle.getAttribute('aria-valuestep'))).to.equal(SLIDER_OPTIONS_MINIMAL.step);
              done();
            });
          });
          it('aria-valuenow', function(done) {
            ...
            helpers.next(function() {
              expect(Number(handle.getAttribute('aria-valuenow'))).to.equal(SLIDER_OPTIONS_MINIMAL.value);
              done();
            });
          });
          it('aria-valuetext', function(done) {
            ...
            helpers.next(function() {
              expect(Number(handle.getAttribute('aria-valuetext'))).to.equal(SLIDER_OPTIONS_MINIMAL.value);
              done();
            });
          });
        });
        ...
        describe('setValue(value)', function() {
          it('should set aria-valuenow and aria-valuetext', function(done) {
            ...
            helpers.next(function() {
              expect(Number(handle.getAttribute('aria-valuenow'))).to.equal(value);
              done();
            });
          });
          ...
          it('should correctly snap aria-valuenow to the nearest step', function(done) {
            ...
            helpers.next(function() {
              expect(Number(handle.getAttribute('aria-valuenow'))).to.equal(expectedSnap);
              done();
            });
          });
        });
    ...
    it('moves the value to the next step using keys', function(done) {
      ...
      helpers.next(function() {
        currVal = parseInt(input.value, 10);
