describe('Coral.ActionBar', function() {
  ...
  describe('Instantiation', function() {
    ...
    describe('clone component via markup', function() {
      helpers.cloneComponent(window.__html__['Coral.ActionBar.base.html']);
    });

    describe('clone component via markup without containers', function() {
      helpers.cloneComponent(window.__html__['Coral.ActionBar.containers.none.html']);
    });

    describe('clone component via markup with disabled', function() {
      helpers.cloneComponent(window.__html__['Coral.ActionBar.disabled.html']);
    });
  ...
  describe('Markup', function() {
    ...
    it('should generate the matching content zones', function(done) {
      var markup = '<coral-actionbar></coral-actionbar>';
      helpers.build(markup, function(bar) {
    ...
    it('should be possible to instantiate a complex actionbar using markup', function(done) {
      ...
      helpers.build(window.__html__['Coral.ActionBar.base.html'], function(bar) {
    ...
    it('should be possible to instantiate a actionbar without wrapper components using markup', function(done) {
      // should be possible to create elements using snippets
      helpers.build(window.__html__['Coral.ActionBar.containers.none.html'], function(bar) {
        expect(bar.primary.threshold).to.equal(-1);
    ...
    describe('#coral-actionbar-container', function() {
      it('should generate the matching content zones with all containers', function(done) {
        var markup = '<coral-actionbar><coral-actionbar-container></coral-actionbar-container><coral-actionbar-container></coral-actionbar-container></coral-actionbar>';
        helpers.build(markup, function(bar) {
          expect(bar.primary).to.exist;
      ...
      it('should generate the matching content zones with one container', function(done) {
        var markup = '<coral-actionbar><coral-actionbar-container></coral-actionbar-container></coral-actionbar>';
        helpers.build(markup, function(bar) {
          expect(bar.primary).to.exist;
          expect(bar.primary.tagName).to.equal('CORAL-ACTIONBAR-PRIMARY');
          expect(bar.secondary).to.exist;
      ...
      it('should copy the container configurations to the new container', function(done) {
        helpers.build(window.__html__['Coral.ActionBar.containers.legacy.html'], function(el) {
      ...
      it('should copy content into new container', function(done) {
        var markup = '<coral-actionbar><coral-actionbar-container><span>TextContent</span></coral-actionbar-container></coral-actionbar>';
        helpers.build(markup, function(bar) {
      ...
      it('should copy over existing items', function(done) {
        helpers.build(window.__html__['Coral.ActionBar.containers.legacy.html'], function(el) {
  ...
  describe('User Interaction', function() {
    ...
    it('should be possible to make two bars that switch', function(done) {
      // should be possible to create elements using snippets
      helpers.build(window.__html__['Coral.ActionBar.visibility.html'], function(bar) {
